...
func (n *NClient) POSTProductsProductidApisApiidStagesStageidAssociateusageplan_TF(ctx context.Context, r *PrimitivePOSTProductsProductidApisApiidStagesStageidAssociateusageplanRequest) (*POSTProductsProductidApisApiidStagesStageidAssociateusageplanResponse, error) {
	t, err := n.POSTProductsProductidApisApiidStagesStageidAssociateusageplan(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_POSTProductsProductidApisApiidStagesStageidAssociateusageplan(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_POSTProductsProductidApisApiidStagesStageidAssociateusageplan(ctx context.Context, data map[string]interface{}) (types.Object, error) {
