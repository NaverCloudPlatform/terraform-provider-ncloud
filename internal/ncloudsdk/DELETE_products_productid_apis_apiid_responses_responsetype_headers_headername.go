...
func (n *NClient) DELETEProductsProductidApisApiidResponsesResponsetypeHeadersHeadername_TF(ctx context.Context, r *PrimitiveDELETEProductsProductidApisApiidResponsesResponsetypeHeadersHeadernameRequest) (*DELETEProductsProductidApisApiidResponsesResponsetypeHeadersHeadernameResponse, error) {
	t, err := n.DELETEProductsProductidApisApiidResponsesResponsetypeHeadersHeadername(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_DELETEProductsProductidApisApiidResponsesResponsetypeHeadersHeadername(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_DELETEProductsProductidApisApiidResponsesResponsetypeHeadersHeadername(ctx context.Context, data map[string]interface{}) (types.Object, error) {
