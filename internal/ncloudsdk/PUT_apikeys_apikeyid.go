...
func (n *NClient) PUTApikeysApikeyid_TF(ctx context.Context, r *PrimitivePUTApikeysApikeyidRequest) (*PUTApikeysApikeyidResponse, error) {
	t, err := n.PUTApikeysApikeyid(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_PUTApikeysApikeyid(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_PUTApikeysApikeyid(ctx context.Context, data map[string]interface{}) (types.Object, error) {
