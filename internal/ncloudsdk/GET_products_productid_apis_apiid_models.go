...
func (n *NClient) GETProductsProductidApisApiidModels_TF(ctx context.Context, r *PrimitiveGETProductsProductidApisApiidModelsRequest) (*GETProductsProductidApisApiidModelsResponse, error) {
	t, err := n.GETProductsProductidApisApiidModels(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETProductsProductidApisApiidModels(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETProductsProductidApisApiidModels(ctx context.Context, data map[string]interface{}) (types.Object, error) {
