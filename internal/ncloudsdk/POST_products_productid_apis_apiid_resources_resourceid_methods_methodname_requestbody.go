...
func (n *NClient) POSTProductsProductidApisApiidResourcesResourceidMethodsMethodnameRequestbody_TF(ctx context.Context, r *PrimitivePOSTProductsProductidApisApiidResourcesResourceidMethodsMethodnameRequestbodyRequest) (*POSTProductsProductidApisApiidResourcesResourceidMethodsMethodnameRequestbodyResponse, error) {
	t, err := n.POSTProductsProductidApisApiidResourcesResourceidMethodsMethodnameRequestbody(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_POSTProductsProductidApisApiidResourcesResourceidMethodsMethodnameRequestbody(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_POSTProductsProductidApisApiidResourcesResourceidMethodsMethodnameRequestbody(ctx context.Context, data map[string]interface{}) (types.Object, error) {
