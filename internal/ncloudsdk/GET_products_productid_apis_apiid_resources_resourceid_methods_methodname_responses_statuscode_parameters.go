...
func (n *NClient) GETProductsProductidApisApiidResourcesResourceidMethodsMethodnameResponsesStatuscodeParameters_TF(ctx context.Context, r *PrimitiveGETProductsProductidApisApiidResourcesResourceidMethodsMethodnameResponsesStatuscodeParametersRequest) (*GETProductsProductidApisApiidResourcesResourceidMethodsMethodnameResponsesStatuscodeParametersResponse, error) {
	t, err := n.GETProductsProductidApisApiidResourcesResourceidMethodsMethodnameResponsesStatuscodeParameters(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETProductsProductidApisApiidResourcesResourceidMethodsMethodnameResponsesStatuscodeParameters(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETProductsProductidApisApiidResourcesResourceidMethodsMethodnameResponsesStatuscodeParameters(ctx context.Context, data map[string]interface{}) (types.Object, error) {
