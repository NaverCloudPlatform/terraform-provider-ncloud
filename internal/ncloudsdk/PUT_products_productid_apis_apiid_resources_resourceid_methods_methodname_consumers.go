...
func (n *NClient) PUTProductsProductidApisApiidResourcesResourceidMethodsMethodnameConsumers_TF(ctx context.Context, r *PrimitivePUTProductsProductidApisApiidResourcesResourceidMethodsMethodnameConsumersRequest) (*PUTProductsProductidApisApiidResourcesResourceidMethodsMethodnameConsumersResponse, error) {
	t, err := n.PUTProductsProductidApisApiidResourcesResourceidMethodsMethodnameConsumers(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_PUTProductsProductidApisApiidResourcesResourceidMethodsMethodnameConsumers(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_PUTProductsProductidApisApiidResourcesResourceidMethodsMethodnameConsumers(ctx context.Context, data map[string]interface{}) (types.Object, error) {
