...
func (n *NClient) GETProductsProductidApisApiidStagesStageidCanarySwaggerjson_TF(ctx context.Context, r *PrimitiveGETProductsProductidApisApiidStagesStageidCanarySwaggerjsonRequest) (*GETProductsProductidApisApiidStagesStageidCanarySwaggerjsonResponse, error) {
	t, err := n.GETProductsProductidApisApiidStagesStageidCanarySwaggerjson(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETProductsProductidApisApiidStagesStageidCanarySwaggerjson(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETProductsProductidApisApiidStagesStageidCanarySwaggerjson(ctx context.Context, data map[string]interface{}) (types.Object, error) {
