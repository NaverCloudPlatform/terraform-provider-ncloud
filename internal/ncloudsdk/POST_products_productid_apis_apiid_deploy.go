...
func (n *NClient) POSTProductsProductidApisApiidDeploy_TF(ctx context.Context, r *PrimitivePOSTProductsProductidApisApiidDeployRequest) (*POSTProductsProductidApisApiidDeployResponse, error) {
	t, err := n.POSTProductsProductidApisApiidDeploy(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_POSTProductsProductidApisApiidDeploy(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_POSTProductsProductidApisApiidDeploy(ctx context.Context, data map[string]interface{}) (types.Object, error) {
