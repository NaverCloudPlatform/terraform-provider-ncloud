...
func (n *NClient) DELETEAuthorizersAuthorizerid_TF(ctx context.Context, r *PrimitiveDELETEAuthorizersAuthorizeridRequest) (*DELETEAuthorizersAuthorizeridResponse, error) {
	t, err := n.DELETEAuthorizersAuthorizerid(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_DELETEAuthorizersAuthorizerid(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_DELETEAuthorizersAuthorizerid(ctx context.Context, data map[string]interface{}) (types.Object, error) {
