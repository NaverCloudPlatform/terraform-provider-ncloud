...
func (n *NClient) PATCHProductsProductidApikeysApikeyid_TF(ctx context.Context, r *PrimitivePATCHProductsProductidApikeysApikeyidRequest) (*PATCHProductsProductidApikeysApikeyidResponse, error) {
	t, err := n.PATCHProductsProductidApikeysApikeyid(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_PATCHProductsProductidApikeysApikeyid(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_PATCHProductsProductidApikeysApikeyid(ctx context.Context, data map[string]interface{}) (types.Object, error) {
