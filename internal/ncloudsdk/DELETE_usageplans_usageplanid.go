...
func (n *NClient) DELETEUsageplansUsageplanid_TF(ctx context.Context, r *PrimitiveDELETEUsageplansUsageplanidRequest) (*DELETEUsageplansUsageplanidResponse, error) {
	t, err := n.DELETEUsageplansUsageplanid(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_DELETEUsageplansUsageplanid(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_DELETEUsageplansUsageplanid(ctx context.Context, data map[string]interface{}) (types.Object, error) {
