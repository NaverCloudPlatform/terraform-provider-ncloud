...
func (n *NClient) POSTProductsProductidApisImport_TF(ctx context.Context, r *PrimitivePOSTProductsProductidApisImportRequest) (*POSTProductsProductidApisImportResponse, error) {
	t, err := n.POSTProductsProductidApisImport(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_POSTProductsProductidApisImport(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_POSTProductsProductidApisImport(ctx context.Context, data map[string]interface{}) (types.Object, error) {
