...
func (n *NClient) GETApikeysApikeyidProducts_TF(ctx context.Context, r *PrimitiveGETApikeysApikeyidProductsRequest) (*GETApikeysApikeyidProductsResponse, error) {
	t, err := n.GETApikeysApikeyidProducts(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETApikeysApikeyidProducts(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETApikeysApikeyidProducts(ctx context.Context, data map[string]interface{}) (types.Object, error) {
