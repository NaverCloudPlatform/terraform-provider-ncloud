...
func (n *NClient) POSTAuthorizers_TF(ctx context.Context, r *PrimitivePOSTAuthorizersRequest) (*POSTAuthorizersResponse, error) {
	t, err := n.POSTAuthorizers(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_POSTAuthorizers(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_POSTAuthorizers(ctx context.Context, data map[string]interface{}) (types.Object, error) {
