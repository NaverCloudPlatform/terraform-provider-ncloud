...
func (n *NClient) GETApikeys_TF(ctx context.Context, r *PrimitiveGETApikeysRequest) (*GETApikeysResponse, error) {
	t, err := n.GETApikeys(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETApikeys(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETApikeys(ctx context.Context, data map[string]interface{}) (types.Object, error) {
