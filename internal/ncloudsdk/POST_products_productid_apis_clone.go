...
func (n *NClient) POSTProductsProductidApisClone_TF(ctx context.Context, r *PrimitivePOSTProductsProductidApisCloneRequest) (*POSTProductsProductidApisCloneResponse, error) {
	t, err := n.POSTProductsProductidApisClone(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_POSTProductsProductidApisClone(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_POSTProductsProductidApisClone(ctx context.Context, data map[string]interface{}) (types.Object, error) {
