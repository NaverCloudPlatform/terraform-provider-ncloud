...
func (n *NClient) GETDashboardsApikeysApikeyidProductsProductidCharts_TF(ctx context.Context, r *PrimitiveGETDashboardsApikeysApikeyidProductsProductidChartsRequest) (*GETDashboardsApikeysApikeyidProductsProductidChartsResponse, error) {
	t, err := n.GETDashboardsApikeysApikeyidProductsProductidCharts(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETDashboardsApikeysApikeyidProductsProductidCharts(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETDashboardsApikeysApikeyidProductsProductidCharts(ctx context.Context, data map[string]interface{}) (types.Object, error) {
