...
func (n *NClient) GETUsageplans_TF(ctx context.Context, r *PrimitiveGETUsageplansRequest) (*GETUsageplansResponse, error) {
	t, err := n.GETUsageplans(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETUsageplans(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETUsageplans(ctx context.Context, data map[string]interface{}) (types.Object, error) {
