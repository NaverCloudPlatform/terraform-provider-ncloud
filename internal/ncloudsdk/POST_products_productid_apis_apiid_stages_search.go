...
func (n *NClient) POSTProductsProductidApisApiidStagesSearch_TF(ctx context.Context, r *PrimitivePOSTProductsProductidApisApiidStagesSearchRequest) (*POSTProductsProductidApisApiidStagesSearchResponse, error) {
	t, err := n.POSTProductsProductidApisApiidStagesSearch(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_POSTProductsProductidApisApiidStagesSearch(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_POSTProductsProductidApisApiidStagesSearch(ctx context.Context, data map[string]interface{}) (types.Object, error) {
