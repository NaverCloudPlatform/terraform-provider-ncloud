...
func (n *NClient) GETProductsProductidApisApiidStagesStageidExport_TF(ctx context.Context, r *PrimitiveGETProductsProductidApisApiidStagesStageidExportRequest) (*GETProductsProductidApisApiidStagesStageidExportResponse, error) {
	t, err := n.GETProductsProductidApisApiidStagesStageidExport(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETProductsProductidApisApiidStagesStageidExport(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETProductsProductidApisApiidStagesStageidExport(ctx context.Context, data map[string]interface{}) (types.Object, error) {
