...
func (n *NClient) POSTApikeysApikeyidSubscribe_TF(ctx context.Context, r *PrimitivePOSTApikeysApikeyidSubscribeRequest) (*POSTApikeysApikeyidSubscribeResponse, error) {
	t, err := n.POSTApikeysApikeyidSubscribe(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_POSTApikeysApikeyidSubscribe(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_POSTApikeysApikeyidSubscribe(ctx context.Context, data map[string]interface{}) (types.Object, error) {
