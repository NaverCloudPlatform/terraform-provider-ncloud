...
func (n *NClient) DELETEProductsProductidApisApiid_TF(ctx context.Context, r *PrimitiveDELETEProductsProductidApisApiidRequest) (*DELETEProductsProductidApisApiidResponse, error) {
	t, err := n.DELETEProductsProductidApisApiid(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_DELETEProductsProductidApisApiid(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_DELETEProductsProductidApisApiid(ctx context.Context, data map[string]interface{}) (types.Object, error) {
