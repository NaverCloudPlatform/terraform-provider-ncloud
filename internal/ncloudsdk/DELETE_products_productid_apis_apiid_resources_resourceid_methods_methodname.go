...
func (n *NClient) DELETEProductsProductidApisApiidResourcesResourceidMethodsMethodname_TF(ctx context.Context, r *PrimitiveDELETEProductsProductidApisApiidResourcesResourceidMethodsMethodnameRequest) (*DELETEProductsProductidApisApiidResourcesResourceidMethodsMethodnameResponse, error) {
	t, err := n.DELETEProductsProductidApisApiidResourcesResourceidMethodsMethodname(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_DELETEProductsProductidApisApiidResourcesResourceidMethodsMethodname(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_DELETEProductsProductidApisApiidResourcesResourceidMethodsMethodname(ctx context.Context, data map[string]interface{}) (types.Object, error) {
