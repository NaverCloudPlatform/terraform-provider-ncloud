...
func (n *NClient) GETProductsProductidApisApiidStagesStageid_TF(ctx context.Context, r *PrimitiveGETProductsProductidApisApiidStagesStageidRequest) (*GETProductsProductidApisApiidStagesStageidResponse, error) {
	t, err := n.GETProductsProductidApisApiidStagesStageid(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETProductsProductidApisApiidStagesStageid(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETProductsProductidApisApiidStagesStageid(ctx context.Context, data map[string]interface{}) (types.Object, error) {
