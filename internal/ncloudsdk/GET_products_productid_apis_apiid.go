...
func (n *NClient) GETProductsProductidApisApiid_TF(ctx context.Context, r *PrimitiveGETProductsProductidApisApiidRequest) (*GETProductsProductidApisApiidResponse, error) {
	t, err := n.GETProductsProductidApisApiid(ctx, r)
	if err != nil {
		return nil, err
	}

	res, err := ConvertToFrameworkTypes_GETProductsProductidApisApiid(context.TODO(), t)
	if err != nil {
		return nil, err
	}
...
func convertToObject_GETProductsProductidApisApiid(ctx context.Context, data map[string]interface{}) (types.Object, error) {
