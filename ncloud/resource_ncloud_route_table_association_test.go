...
func testAccCheckRouteTableAssociationDisappears(instance *vpc.Route) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		client := testAccProvider.Meta().(*NcloudAPIClient)
		...
		waitForNcloudRouteTableAssociationTableUpdate(client, *instance.RouteTableNo)
