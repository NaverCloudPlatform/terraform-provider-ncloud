...
func TestAccResourceNcloudAutoScalingSchedule_classic_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		CheckDestroy: func(state *terraform.State) error {
			return testAccCheckNcloudAutoScalingScheduleDestroy(state, testAccClassicProvider)
		},
		Steps: []resource.TestStep{
			{
				Config: testAccNcloudAutoScalingScheduleClassicConfig(name, start, end),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNcloudAutoScalingScheduleExists(resourceName, &schedule, testAccClassicProvider),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNcloudAutoScalingScheduleExists(resourceName, &schedule, testAccClassicProvider),
					testAccCheckResourceDisappears(testAccClassicProvider, resourceNcloudAutoScalingSchedule(), resourceName),
				),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNcloudAutoScalingScheduleExists(resourceName, &schedule, testAccProvider),
					testAccCheckResourceDisappears(testAccProvider, resourceNcloudAutoScalingSchedule(), resourceName),
				),
				ExpectNonEmptyPlan: true,
			},
		},
