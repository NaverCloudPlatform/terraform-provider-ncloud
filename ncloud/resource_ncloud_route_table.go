...
func resourceNcloudRouteTableCreate(d *schema.ResourceData, meta interface{}) error {
	...
	resp, err := client.vpc.V2Api.CreateRouteTable(reqParams)
	if err != nil {
	...
	waitForNcloudRouteTableCreation(client, d.Id())
...
func resourceNcloudRouteTableRead(d *schema.ResourceData, meta interface{}) error {
	...
	instance, err := getRouteTableInstance(client, d.Id())
	if err != nil {
		d.SetId("")
		return err
	}
...
func resourceNcloudRouteTableDelete(d *schema.ResourceData, meta interface{}) error {
	...
	resp, err := client.vpc.V2Api.DeleteRouteTable(reqParams)
	if err != nil {
	...
	waitForNcloudRouteTableDeletion(client, d.Id())

	return nil
}

func waitForNcloudRouteTableCreation(client *NcloudAPIClient, id string) error {
...
func waitForNcloudRouteTableDeletion(client *NcloudAPIClient, id string) error {
	stateConf := &resource.StateChangeConf{
...
func getRouteTableInstance(client *NcloudAPIClient, id string) (*vpc.RouteTable, error) {
	...
	resp, err := client.vpc.V2Api.GetRouteTableDetail(reqParams)
	if err != nil {
